...
console.log(`nodes ${data.nodes.length}, ways ${data.ways.length} (named ${data.ways.filter((w) => w.name).length}), buildings ${data.buildings.length}, pois ${data.pois.length}, areas ${data.areas.length}, lines ${data.lines.length}, trees ${data.trees.length}`);
