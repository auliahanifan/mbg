...
**Jalan hanya untuk kendaraan dan orang.** `clearRoads` menjamin dinding, tapi atap, pagar, halaman, teras, kanopi, dan tandon diturunkan dari *oriented box* — kotak pembungkus footprint, bukan footprint-nya — jadi dulu 5.765 halaman, 3.113 emper, 1.463 atap, 819 kanopi, dan 537 pagar berdiri di atas aspal. Sekarang `frontSide` mengukur jarak dinding→kerb dengan menyusuri koridor jalan apa adanya (bukan lewat koridor yang dilebarkan, yang meleset karena grid `corridorEscape` cuma satu sel), `fitFront` memangkas bentang yang menjulur ke jalan, dan `fitBox` menarik sisi atap sampai tirisnya lepas dari aspal — kalau tak bisa, atapnya jadi tutup datar di atas footprint. Kanopi ruko tetap boleh menaungi trotoar, tidak aspal. Lampu lalu lintas yang tiangnya jatuh di jalan penyeberang digeser mundur (13 dari 28 tidak bergeser, median 2 m), gapura yang pilarnya kena jalan besar dibatalkan, dan pohon OSM yang dipetakan di atas aspal dibuang. Dua test regresi menyapu seluruh kota Purwokerto untuk menjaga ini.
